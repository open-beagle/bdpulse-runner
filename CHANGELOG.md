...
## [v1.12.0](https://github.com/open-beagle/bdpulse-runner/tree/v1.12.0) (2021-11-30)

[Full Changelog](https://github.com/open-beagle/bdpulse-runner/compare/v1.11.0...v1.12.0)

**Implemented enhancements:**

- Add `retries` option to clone manifest [\#22](https://github.com/open-beagle/bdpulse-runner/pull/22) ([julienduchesne](https://github.com/julienduchesne))

## [v1.11.0](https://github.com/open-beagle/bdpulse-runner/tree/v1.11.0) (2021-11-11)

[Full Changelog](https://github.com/open-beagle/bdpulse-runner/compare/v1.10.0...v1.11.0)

**Implemented enhancements:**

- create card path env variable [\#19](https://github.com/open-beagle/bdpulse-runner/pull/19) ([eoinmcafee00](https://github.com/eoinmcafee00))

**Merged pull requests:**

- Release/1.11.0 [\#21](https://github.com/open-beagle/bdpulse-runner/pull/21) ([eoinmcafee00](https://github.com/eoinmcafee00))

## [v1.10.0](https://github.com/open-beagle/bdpulse-runner/tree/v1.10.0) (2021-11-10)

[Full Changelog](https://github.com/open-beagle/bdpulse-runner/compare/v1.9.0...v1.10.0)

**Implemented enhancements:**

- read & upload card data to drone server [\#16](https://github.com/open-beagle/bdpulse-runner/pull/16) ([eoinmcafee00](https://github.com/eoinmcafee00))

**Merged pull requests:**

- Release/1.10.0 [\#18](https://github.com/open-beagle/bdpulse-runner/pull/18) ([eoinmcafee00](https://github.com/eoinmcafee00))
- feat\(proxy\): support for all\_proxy variables [\#15](https://github.com/open-beagle/bdpulse-runner/pull/15) ([ysicing](https://github.com/ysicing))

## [v1.9.0](https://github.com/open-beagle/bdpulse-runner/tree/v1.9.0) (2021-08-26)

[Full Changelog](https://github.com/open-beagle/bdpulse-runner/compare/v1.8.0...v1.9.0)

**Implemented enhancements:**

- \(feat\) add silent version of bash and powershell Script [\#13](https://github.com/open-beagle/bdpulse-runner/pull/13) ([tphoney](https://github.com/tphoney))

**Merged pull requests:**

- \(maint\) v1.9.0 release prep [\#14](https://github.com/open-beagle/bdpulse-runner/pull/14) ([tphoney](https://github.com/tphoney))
